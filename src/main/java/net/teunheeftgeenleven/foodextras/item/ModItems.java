...
public class ModItems {
    ...
    public static final Item ASPARAGUS = registerItem("asparagus",new Item(new Item.Settings().food(ModFoodComponents.VEGGIE)));
    ...
    public static final Item CELERY = registerItem("celery",new Item(new Item.Settings().food(ModFoodComponents.VEGGIE)));
